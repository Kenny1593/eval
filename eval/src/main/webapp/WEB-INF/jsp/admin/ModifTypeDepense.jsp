...
<% TypeDepense typeDepense= (TypeDepense) request.getAttribute("typeDepense");%>
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/modifTyDep">
                        <input type="hidden" name="id" value="<%=typeDepense.getId()%>">
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Nom Depense</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="valeur" value="<%=typeDepense.getValeur()%>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Code</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="code" value="<%=typeDepense.getCode()%>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Budget</label>
                            <div class="col-sm-10">
                                <input type="number" step="any" class="form-control" name="budget" value="<%=typeDepense.getBudget()%>">
                            </div>
                        </div>
