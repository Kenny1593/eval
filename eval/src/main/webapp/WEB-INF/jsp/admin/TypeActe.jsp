        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/insertActe">
                        <div class="row mb-3">
            ...
            <div>
                <form>
                    <table class="table">
                        ...
                        <tr>
                            <td><%= typeActe.getId()%></td>
                            <td><%= typeActe.getValeur()%></td>
                            <td><%= typeActe.getCode()%></td>
                            <td><fmt:formatNumber type="number" maxFractionDigits="3" value="<%= typeActe.getBudget()%>"/></td>
                            <td><a href="<%=request.getContextPath()%>/modifTypeActe/<%=typeActe.getId()%>" class="btn btn-dark">Modifier</a></td>
                        </tr>
                        <% } %>
                        </tbody>
                    </table>
