    ...
    <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="post" action="<%=request.getContextPath()%>/modifPatient">
            <input type="hidden" name="id" value="<%=patient.getId()%>">

            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">Nom Patient</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="nom" value="<%=patient.getNom()%>">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">Date d'Ajout</label>
              <div class="col-sm-10">
                <input type="datetime-local" class="form-control" name="dateAjout" value="<%=patient.getDateAjout()%>">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">Date de Naissance</label>
              <div class="col-sm-10">
                <input type="datetime-local" class="form-control" name="dateNaissance" value="<%=patient.getDateNaissance()%>">
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <select class="form-select" aria-label="Default select example" name="genre">
                  ...
                  <option value="<%=patient.getGenre()%>">Homme</option>
                  <% } else { %>
                  <option value="<%=patient.getGenre()%>">Femme</option>
                  <% } %>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <select class="form-select" aria-label="Default select example" name="remboursement">
                  ...
                  <option value="<%=patient.getRemboursement()%>">True</option>
                  <% } else { %>
                  <option value="<%=patient.getRemboursement()%>">False</option>
                  <% } %>
