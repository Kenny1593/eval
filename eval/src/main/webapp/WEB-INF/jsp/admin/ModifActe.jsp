...
<% TypeActe typeActe= (TypeActe) request.getAttribute("typeActe");%>
    ...
    <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="post" action="<%=request.getContextPath()%>/modifActe">
            <input type="hidden" name="id" value="<%=typeActe.getId()%>">
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">Nom Acte</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="valeur" value="<%=typeActe.getValeur()%>">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">Code</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="code" value="<%=typeActe.getCode()%>">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">Budget</label>
              <div class="col-sm-10">
                <input type="number" step="any" class="form-control" name="budget" value="<%=typeActe.getBudget()%>">
              </div>
            </div>
