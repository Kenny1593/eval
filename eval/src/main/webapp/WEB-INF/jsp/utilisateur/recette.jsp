...
<main id="main" class="main">
    ...
    <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/detail">
                        ...
                        <input type="hidden" name="facture.id" value="<%=fact.getId()%>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="any" class="form-control" name="montant">
                            </div>
                        </div>
            ...
            <div>
                <form>
                    <table class="table">
                        ...
                        <% if(fact.getId()==detailActePatient.getFacture().getId()){%>
                        <tr>

                            <td><%= detailActePatient.getId()%></td>
                            <td><%= detailActePatient.getFacture().getId()%></td>
                            <td><%= detailActePatient.getTypeActe().getValeur()%></td>
                            <td><%= detailActePatient.getMontant()%></td>
                            <td><a href="<%=request.getContextPath()%>/modifdetail/<%=detailActePatient.getId()%>" class="btn btn-dark">Modifier</a></td>
                        </tr>
                        <% }%>
                        <% }%>
        ...
        <p class="card-text"><a href="<%= request.getContextPath()%>/terminer" class="btn-dark">Terminer</a></p>
    </section>
