        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/modifDep">
                        <input type="hidden" name="id" value="<%=depense.getId()%>">

                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Ajout Type Depense</label>
                            <div class="col-sm-10">
                                <select class="form-select" aria-label="Default select example" name="typeDepense.id">
                                    <option value="<%=depense.getTypeDepense().getId()%>"><%=depense.getTypeDepense().getValeur()%></option>
                                    <% for(TypeDepense typeDepense: typeDepenses){ %>
                                    <option value="<%=typeDepense.getId()%>"><%=typeDepense.getValeur()%></option>
                                    <% } %>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="any" class="form-control" name="montant" value="<%=depense.getMontant()%>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Date</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" name="date" value="<%=depense.getDate()%>">
                            </div>
                        </div>
