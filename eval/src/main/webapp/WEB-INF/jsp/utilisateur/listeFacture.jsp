                ...
                <form>
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><%= facture.getId()%></td>
                            <td><%= facture.getPatient().getNom()%></td>
                            <td><fmt:formatDate type="both" value="<%= facture.getDate()%>" pattern="dd MMMM yyyy"/></td>

                            <td><a href="<%=request.getContextPath()%>/factu/<%=facture.getId()%>" class="btn btn-primary">Voir detail</a></td>
                            <td><a href="<%=request.getContextPath()%>/modifFact/<%=facture.getId()%>" class="btn btn-dark">Modifier</a></td>
